      ...
      >
        ...
        <div className="flex flex-col items-center" style={{ transform: 'translateZ(20px)' }}>
          ...
          <div className="flex space-x-5 mt-8">
            <a href="https://x.com/DhageDev002" target='blank' className="text-white/70 hover:text-indigo-400 transition duration-300 transform hover:scale-110">
            ...
            <a href="https://github.com/JagdishDhage" target='blank' className="text-white/70 hover:text-indigo-400 transition duration-300 transform hover:scale-110">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="https://www.linkedin.com/in/jagdish-dhage-37080232a/" target='blank' className="text-white/70 hover:text-indigo-400 transition duration-300 transform hover:scale-110">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
